...
# 数据集路径
train_dir = "private_data/raw/train"
val_dir = "private_data/raw/val"
test_dir = "private_data/raw/test"
...
print("接下来可以将这些文件上传到GitHub，然后在云服务器上使用Chinese-CLIP的build_lmdb_dataset.py脚本将数据转换为LMDB格式") 